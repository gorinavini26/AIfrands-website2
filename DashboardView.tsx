      ...
      <div className="w-full max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            {/* LEARNING LINKS & WEBINARS */}
            <div className="bg-white rounded-3xl border-2 border-slate-200/90 p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-extrabold text-indigo-600 uppercase tracking-widest">Learning Hub</p>
                  <h3 className="text-sm font-extrabold text-slate-900 mt-0.5">Links & Webinars</h3>
                </div>
                <span className="material-symbols-outlined text-indigo-600">open_in_new</span>
              </div>

              <div className="space-y-2">
                <a
                  href="https://www.youtube.com/results?search_query=AI+ML+webinar+for+students"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between gap-3 p-3 rounded-2xl bg-red-50 border border-red-100 hover:border-red-300 hover:bg-red-100 transition-all group"
                >
                  <span className="flex items-center gap-2.5 min-w-0">
                    <span className="w-8 h-8 rounded-xl bg-red-600 text-white flex items-center justify-center shrink-0">
                      <span className="material-symbols-outlined text-base">play_arrow</span>
                    </span>
                    <span className="min-w-0">
                      <span className="block text-xs font-extrabold text-slate-900 truncate">AI/ML Webinars</span>
                      <span className="block text-[10px] text-slate-500 font-medium">Open curated video results</span>
                    </span>
                  </span>
                  <span className="material-symbols-outlined text-sm text-slate-400 group-hover:text-red-600">arrow_forward</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between gap-3 p-3 rounded-2xl bg-indigo-50 border border-indigo-100 hover:border-indigo-300 hover:bg-indigo-100 transition-all group"
                >
                  <span className="flex items-center gap-2.5 min-w-0">
                    ...
                    <span className="min-w-0">
                      <span className="block text-xs font-extrabold text-slate-900 truncate">Developer Docs</span>
                      <span className="block text-[10px] text-slate-500 font-medium">Reliable web references</span>
                    </span>
                  </span>
                  <span className="material-symbols-outlined text-sm text-slate-400 group-hover:text-indigo-600">arrow_forward</span>
                </a>

                <button
                  type="button"
                  onClick={() => onNavigateTab('resources')}
                  className="w-full flex items-center justify-between gap-3 p-3 rounded-2xl bg-emerald-50 border border-emerald-100 hover:border-emerald-300 hover:bg-emerald-100 transition-all group text-left"
                >
                  <span className="flex items-center gap-2.5 min-w-0">
                    ...
                    <span className="min-w-0">
                      <span className="block text-xs font-extrabold text-slate-900 truncate">Study Notebooks</span>
                      <span className="block text-[10px] text-slate-500 font-medium">Open your saved notes</span>
                    </span>
                  </span>
