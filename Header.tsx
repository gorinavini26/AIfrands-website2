    ...
    <header className="fixed top-0 left-0 lg:left-64 right-0 h-16 bg-white/95 backdrop-blur-md border-b border-slate-200/80 z-40 flex items-center justify-between px-4 sm:px-6 shadow-xs">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-amber-50 border-2 border-amber-300 hover:bg-amber-100 rounded-2xl text-amber-900 font-extrabold text-xs shadow-2xs cursor-pointer transition-all active:scale-95"
          title="View streak details"
          aria-label="View learning streak details"
        >
